...
class BlogPost < ActiveRecord::Base
  ...
  attr_accessible :title, :body, :tag_list, :draft, :published_at, :event_date, :browser_title, :meta_keywords, :meta_description, :user_id, :category_ids, :custom_url, :custom_teaser
